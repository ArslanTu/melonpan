...
class BookSubject(Subject, RateableSubject):
    authors = models.ManyToManyField(Person, related_name='write_book_set', verbose_name='作者', blank=False)
    ...
    translators = models.ManyToManyField(Person, related_name='translate_book_set', verbose_name='译者', blank=True)
