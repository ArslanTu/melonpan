...
class RateableSubject(models.Model):
    ...
    imdb_link = models.URLField(max_length=256, verbose_name='IMDb 链接', blank=True, null=False)
    ...
    douban_link = models.URLField(max_length=256, verbose_name='豆瓣链接', blank=True, null=False)
    ...
    bangumi_link = models.URLField(max_length=256, verbose_name='Bangumi 链接', blank=True, null=False)
