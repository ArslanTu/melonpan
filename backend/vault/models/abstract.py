...
class RateableSubject(models.Model):
    ...
    imdb_rating_count = models.PositiveSmallIntegerField(verbose_name='IMDb 评分人数', blank=True,
                                                         null=True)
    ...
    douban_rating_count = models.PositiveSmallIntegerField(verbose_name='豆瓣评分人数', blank=True,
                                                           null=True)
    ...
    bangumi_rating_count = models.PositiveSmallIntegerField(verbose_name='Bangumi 评分人数', blank=True,
                                                            null=True)
