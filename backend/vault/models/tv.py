...
class TVSubject(Subject, RateableSubject):
    directors = models.ManyToManyField(PersonSubject, related_name='direct_tv_subject_set', verbose_name='导演',
                                       blank=True)
    screenwriters = models.ManyToManyField(PersonSubject, related_name='write_tv_subject_set', verbose_name='编剧',
                                           blank=True)
    actors = models.ManyToManyField(PersonSubject, related_name='act_tv_subject_set', verbose_name='主演', blank=True)
